...
public class Assignment12 {
	...
	public static void main(String[] args) {
		...
		System.out.println("1. Number of Words in given sentence: " + count);
		
		System.out.println();
		System.out.println("2. Reverse order of words in given sentence: ");
		...
		System.out.println("3. First character of each word in given sentence should be Upper Case: ");
