...
public class DataTypes {
	...
	public static void main(String[] args) {
		...
		System.out.println("Temperature of a city in degrees Celsius: " + temparature);
		...
		System.out.println("Amount of money in a customer's bank account is: " + amount);
		...
		System.out.println("Coordinates of a location (latitude, longitude) is: " + latitude + ", " + longitude);
